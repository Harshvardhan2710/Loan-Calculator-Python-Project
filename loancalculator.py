...
#title
title_label = Label(root, text="Loan Claculator", font=("Arial", 25, "bold"), bg="black", fg="lightblue")
title_label.place(x=400, y=30)

#label and Entry fields
loan_amount_lab = Label(root, text="Loan Amount : ", font = f)
...
total_payment_lab = Label(root, text="Total Payment is ", font=f)
...
#button to calculate
cal_btn = Button(root, text="Calculate", font=f, command=calculate_loan)
cal_btn.place(x=450 , y=300)
